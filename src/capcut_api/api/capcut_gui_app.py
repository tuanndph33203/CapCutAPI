...
def activate_capcut_for_image_workflow():
    ...
    try:
        ...
        # Kỹ thuật 5: TOPMOST + FRAMECHANGED để taskbar nhận ra
        ...
        # Kỹ thuật 5: AttachThreadInput bypass foreground lock
        try:
            fore_hwnd = win32gui.GetForegroundWindow()
            fore_tid = win32process.GetWindowThreadProcessId(fore_hwnd)[0] if fore_hwnd else 0
            app_tid = win32api.GetCurrentThreadId()
        ...
        # Kỹ thuật 6: PowerShell AppActivate
        ...
        # Kỹ thuật 7: WM_SETFOCUS + WM_ACTIVATE
        try:
